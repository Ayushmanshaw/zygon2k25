...
//           start: 'top 90%', // Adjusted for mobile compatibility
//           end: 'center center',
//           scrub: 1,
//         },
//       }
...
//             style={{ backgroundImage: 'url("/noise-form.png")' }}
//           />

//           {/* Static Shapes */}
//           <div className="absolute top-[10%] left-[10%] w-8 h-8 md:w-16 md:h-16 
//             bg-[#2d2d2d] rounded-full opacity-80" 
//           />
//           <div className="absolute bottom-[20%] left-[15%] w-12 h-12 md:w-24 md:h-24 
//             bg-[#2d2d2d] opacity-80" 
//             style={{ 
//               clipPath: 'polygon(30% 0%, 70% 0%, 100% 30%, 100% 70%, 70% 100%, 30% 100%, 0% 70%, 0% 30%)'
//             }} 
//           />
//           <div className="absolute top-[20%] right-[10%] w-16 h-16 md:w-32 md:h-32 
//             bg-[#2d2d2d] rounded-full opacity-80"
//           />

//           {/* Content */}
//           <div className="relative z-10 flex items-center justify-center h-full p-4">
//             <h1 className="text-4xl md:text-8xl lg:text-[180px] 
//               font-bold text-[#2d2d2d] tracking-tighter text-center leading-none"
//             >
//               ABOUT ZYGON
//             </h1>
//           </div>
...
//         <section
//           ref={nextSectionRef}
//           className="absolute top-0 w-full h-full bg-gradient-to-b from-gray-900 to-gray-800"
//           style={{
...
//             <h2
//               ref={textRef}
//               className="text-2xl md:text-6xl text-white font-bold text-center max-w-4xl"
//             >
      ...
      <div ref={containerRef} className="relative h-[100dvh] overflow-hidden">
        ...
        >
          ...
          <div
            ...
            style={{ backgroundImage: 'url("invert3.png")' }}
          />
          {/* Static Shapes */}
          <div className="absolute top-[10%] left-[10%] w-8 h-8 md:w-16 md:h-16 bg-[#ffffff] rounded-full " />
          <div
            className="absolute bottom-[20%] left-[15%] w-12 h-12 md:w-24 md:h-24 bg-[#ffffff] "
            style={{
              clipPath:
          ...
          {/* Content */}
          <div className="relative z-10 flex items-center justify-center h-full p-4">
            <h1 className="text-7xl md:text-8xl lg:text-[180px] font-bold tracking-tighter text-center leading-none text-white" style={{ fontFamily: "Carnival" }}>
              WHAT IS ZYGON ?
            </h1>
          </div>
        </section>
