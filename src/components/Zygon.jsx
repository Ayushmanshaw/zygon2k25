...
const Zygon = () => {
    return (
        ...
        <div className=" bg-[url('invert2.png')] cookie-regular w-screen h-screen bg-cover bg-center text-black"  >
            <div className="!flex ps-3 pt-6">
                <div align="center" className="text-6xl !text-center" style={{ writingMode: "vertical-rl", fontFamily: "Carnival" }}>
                    2K25
                </div>
                <div className='animate__animated animate__fadeInLeft wow'>
                    <div className='text-7xl' style={{ fontFamily: "Carnival" }}>
                        ZYGON
                    </div>
                    <div className='text-2xl text-gray-700' style={{ fontFamily: "Carnival" }}>
                        Spin The Wheel Of Wonders
                    </div>

                </div>
            </div>
            <div className='text-2xl text-black mt-4 px-5 text-justify animate__animated animate__fadeInUp wow '>
